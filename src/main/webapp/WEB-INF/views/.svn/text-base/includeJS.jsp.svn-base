...
<script type="text/javascript" src="<c:url value="/resources/js/bootstrap-alert.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/js/bootstrap-modal.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/js/bootstrap-dropdown.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/js/bootstrap-scrollspy.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/js/bootstrap-tab.js" />"></script>
...
<script type="text/javascript" src="<c:url value="/resources/js/jquery.tagify.js" />"></script>
